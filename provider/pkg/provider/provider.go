...
// constructCluster is an implementation of Construct for the Cluster component.
func constructCluster(ctx *pulumi.Context, name string, inputs provider.ConstructInputs,
	options pulumi.ResourceOption) (*provider.ConstructResult, error) {

	// Copy the raw inputs to ClusterArgs. `inputs.CopyTo` uses the types and `pulumi:` tags
	...
	bucket, err := NewCluster(ctx, name, args, options)
	if err != nil {
